...
## Seederファイルについて
管理者1名、一般ユーザー3名が登録されています。<br />
未認証ユーザーはメール認証機能の確認に使用できます。
...
### 【勤怠情報】
* 直近30日分、出勤・退勤時間（ランダム）・休憩時間（1回または2回）で登録されています。
...
* 勤怠情報を修正または修正申請する際、出勤・退勤時間は入力必須項目となり、<br />
欠勤にすることはできません。
* 一般ユーザーによる勤怠情報修正の申請中は、管理者が承認するまで<br />
一般ユーザー、管理者共に再修正ができません。<br />
承認済みとなれば、再び同じ日の修正申請及び修正が可能となリます。